...
public class cucumberPage extends cucuberBasePage1
{
  ...
  public static String captureInvalidErrorMessage()
  {
	  ...
	  //String text =driver.findElement(invalidErrorMassage).getText();
	  		//(or)
	//  return driver.findElement(invalidErrorMassage).getText();
  }
}
